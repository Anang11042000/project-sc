...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/project-sc/alamyazid/main/proxy-template.py
chmod +x /usr/local/bin/edu-ssh

# Installing Service
cat > /etc/systemd/system/edussh-nontls.service << END
[Unit]
Description=Ssh Websocket By TuanYZ
Documentation=/store
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/project-sc/alamyazid/main/edu-op.py
